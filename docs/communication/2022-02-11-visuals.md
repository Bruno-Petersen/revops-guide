...
3. **Don't take abstraction or analogy too far:** It is easy to forget that visuals are just a representatation of a thing, not the thing itself. We are treating two different things as if they where the same. For example by saying "this line _is_ the relationship between a contact and a company". [^3]
...
4. **Communicating is not sensemaking:** I use sketchings and drawings in two different modes of working. The first mode is making sense of a problem, situation of process. Here I draw out my current understanding and use it to support different lines of thinking. This can be done alone or with a team in front of a whiteboard or to understand other peoples thinking.

The second mode is about communicating. Once I know what I want to say I can start thinking about how best to convey the idea to different [stakeholders](https://revopsguide.net/stakeholders.html).
