...
3. **Don't take abstraction or analogy too far:** It is easy to forget that visuals are just a representatation of a thing, not the thing itself. We are treating two different things as if they where the same. For example by saying "this line represents the relationship between a contact and a company".
