...
I use this regex search pattern to find common weasel words in the posts I write here. The list is by no means complete, but it helps me identify common words that reduce the strenght of writing/
`bit|almost|as much|basically|can|could|farily|in a sense|just|likely|many|may|might|moderately|most|often|probably|quite|rather|relatively|reasonably|seems|some|somehow|somewhat|usually|virtually|practically|very`
